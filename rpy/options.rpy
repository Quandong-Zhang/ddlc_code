...
init python:
    ...
    build.archive("chs", "all")
    build.classify("game/tl/chinese/**.jpg", "chs")
    build.classify("game/tl/chinese/**.png", "chs")
    build.classify("game/tl/chinese/**.txt", "chs")
    build.classify("game/tl/chinese/**.chr", "chs")
    build.classify("game/tl/chinese/**.pdf", "chs")
