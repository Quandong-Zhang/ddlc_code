...
label ch5_main:
    ...
    call showpoem (poem_s3, music=False) from _call_showpoem_1
    mc "Ah--"
    "What is this...?"
    ...
    if _preferences.language == "chinese":
        python:
            try: sys.modules['renpy.error'].report_exception("哦，天啊...我没弄坏什么东西吧？等等，我想我能把它修好...我想...\n事实上，你猜怎么着？我觉得如果把她删了会让事情变得简单许多，是她让情况变得这么复杂的。啊哈哈，现在就没事了。", False)
            except: pass
    else:
        python:
